	...
	return (
		<>
			...
			<div className='summaryCont'>
				<div
					className='mt-5 px-3 pt-2 header order-section d-flex justify-content-between'
					style={{ height: "3rem" }}
				>
						...
						<div className='row'>
							<div className='col-12 col-lg-6  py-2 ms-xxl-2 d-block justify-content-between align-items-center   billing-address '>
								<div className='d-lg-flex d-sm-block justify-content-between  align-items-center'>
									...
									<input
										className={
											formik.values.FirstName ? "green-border input" : "input"
										}
										ref={inputRef}
								...
								{formik.errors.FirstName ? (
									<div className='mt-0 float-end error'>
										{formik.errors.FirstName}
									</div>
								) : null}
								...
								<div className='d-lg-flex d-sm-block mt-4 justify-content-between align-items-center'>
									...
									<input
										className={
											formik.values.LastName ? "green-border input" : "input"
										}
										onChange={formik.handleChange}
								...
								{formik.errors.Email ? (
									<div className='float-end error'>{formik.errors.Email}</div>
								) : null}
								...
								<div className='d-lg-flex d-sm-block  mt-4 justify-content-between align-items-center'>
									...
									<select
										className={
											formik.values.country ? "green-border input" : "input"
										}
										name='country'
										onChange={formik.handleChange}
										id='country'
								...
								<div className='d-lg-flex d-sm-block  mt-4 justify-content-between align-items-center'>
									...
									<input
										className={
											formik.values.city ? "green-border input" : "input"
										}
										onChange={formik.handleChange}
								...
								{formik.errors.city ? (
									<div className='float-end error'>{formik.errors.city}</div>
								) : null}
								...
								<div className='d-lg-flex d-sm-block  mt-4 justify-content-between align-items-center'>
									...
									<input
										className={
											formik.values.postcode ? "green-border input" : "input"
										}
										onChange={formik.handleChange}
										value={formik.values.postcode}
										type='number'
										name='postcode'
										placeholder='6 digits, for example: 908650'
									/>
								</div>
								...
								<div className='d-lg-flex d-sm-block  mt-4 justify-content-between align-items-center'>
									...
									<input
										className={
											formik.values.phone ? "green-border input" : " input"
										}
										onChange={formik.handleChange}
										type='number'
										name='phone'
								...
								{formik.errors.phone ? (
									<div className=' float-end error'>{formik.errors.phone}</div>
								) : null}
							</div>
							...
							<div className='col-12 col-lg-5 py-2  delivery-address ms-md-5'>
								<div>
									<div>
										...
										/>
										<label className='ms-3' htmlFor='default'>
									...
									/>
									<label className='ms-3 mt-3' htmlFor='alternative'>
				...
				<div className='mt-2'>
					<div className='d-flex'>
						...
						/>
						<label className='ms-3' htmlFor='prepay'>
							<b>
								Prepay ₦ 17551 for duties, taxes and fees now to guarantee no
					...
					<div className='d-flex'>
						...
						/>
						<label className='ms-3 mt-4' htmlFor='postpay'>
							<b>
				...
				<div className='row '>
					<div className='col-12 d-block col-xl-6'>
						...
						<img
							src='https://pngimg.com/uploads/visa/visa_PNG17.png'
							className=''
						...
						<p className='mt-3 ' style={{ fontSize: ".7rem" }}>
							By clicking Pay and Place Order, you agree to purchase your
							item(s) from Global-e as merchant of record for this transaction,
							on Global-e’s Terms and Conditions and Privacy Policy. Global-e is
							an international fulfilment service provider to NUFC Store.
						</p>

						<button
							className='order-button mt-3 p-2'
							type='submit'
							onClick={formik.handleSubmit}
							style={{
								backgroundColor: "#c3a572",
								color: "white",
								border: "none",
								borderRadius: ".2rem",
							}}
					...
					<div className='col-12 col-xl-5 ms-xl-5 mt-3 mt-xxl-0 '>
						<div className='mt-2 d-flex justify-content-between'>
							<input
								type='text'
								className={formik.values.coupon ? "green-border" : ""}
								name='coupon'
								onChange={formik.handleChange}
						...
						{formik.errors.coupon ? (
							<div className='error'>{formik.errors.coupon}</div>
						) : null}
				...
				<div className='bottom-footer d-flex justify-content-center gap-2 pt-2 align-items-center header mt-5'>
					<a className='bottomFooter-link' href=''>
						Contact Us
					</a>
				...
				<p className='text-center mt-5 '>
					&copy;2022 Oladapo Timilehin Raspadori
				</p>
			</div>
		</>
	);
